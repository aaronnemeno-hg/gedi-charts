requirejs.config({
    paths: {	
        'chart' : '../vendor/chartv2js/dist/Chart.bundle.min',
        'datalabels' : '../vendor/chartv2js-plugin-datalabels/dist/chartjs-plugin-datalabels',
...
require([
  ...
  'bootstrap'
...
], function($, domReady, chart, ChartDataLabels, bootstrap){
	domReady(function(){
    ...
    function initTabs() {
      //console.log('tab version',$.fn.tab.Constructor.VERSION);
      /*$('.gedi-charts-section-2022 a[data-toggle="tab"]').on('click', function(e){
        console.log('tab clicked', e);
      })*/
      $('.gedi-charts-section-2022 a[data-toggle="tab"]').tab();
